...
This document provides guidelines for internationalization of the ExecuteCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `executecoin_en.ts` remains unchanged.
