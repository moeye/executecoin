...
This mechanism has been integrated into Bitcore-Node-ExecuteCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/executecoinpay/insight-api-executecoin#web-socket-api](https://github.com/executecoinpay/insight-api-executecoin#web-socket-api)
* API: [https://github.com/executecoinpay/insight-api-executecoin#instantsend-transactions](https://github.com/executecoinpay/insight-api-executecoin#instantsend-transactions)
...
By default, the ExecuteCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ExecuteCoin Core daemon:
