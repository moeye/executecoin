...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid executecoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid executecoin address" in e.error['message'])
