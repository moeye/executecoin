...
//! These need to be macros, as clientversion.cpp's and executecoin*-res.rc's voodoo requires it
...
/**
 * executecoind-res.rc includes this file, but it cannot cope with real c++ code.
