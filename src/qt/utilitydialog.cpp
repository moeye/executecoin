    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  executecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ExecuteCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XCQ, 0.1 XCQ, 1 XCQ and 10 XCQ -- sort of like the paper money you use every day.</li> \
