    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XCQ-light"), QVariant("light"));
    ui->theme->addItem(QString("XCQ-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XCQ-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("XCQ-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("XCQ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XCQ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XCQ-traditional"), QVariant("trad"));
