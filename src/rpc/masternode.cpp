...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print ExecuteCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "executecoin",               "masternode",             &masternode,             true,  {} },
    { "executecoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "executecoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "executecoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "executecoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "executecoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
