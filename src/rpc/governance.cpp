...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in executecoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("executecoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "executecoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "executecoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "executecoin",               "gobject",                &gobject,                true,  {} },
    { "executecoin",               "voteraw",                &voteraw,                true,  {} },
